"""
Ambatukam, also known as Ambatukam Omaygot, 
"""
import os
import subprocess
import numpy as np
...
class goodneighboursassociation:
    # holy shit thisi s painful
    ...
    def spectral_waves(self, shape, threshold, nps=None):
        ...
        spg /= spg.max()    # spectrographic normalization shits
